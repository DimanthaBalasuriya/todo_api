...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | You may configure as many filesystem disks as necessary, and you may
    | even configure multiple disks for the same driver. Examples for the
    | supported drivers are below.
    |
    */
    ...
    'disks' => [
        ...
        'r2' => [
            ...
            'bucket' => env('R2_BUCKET_NAME', env('AWS_BUCKET')),
